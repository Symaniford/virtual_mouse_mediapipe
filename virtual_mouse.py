#   Copyright [Google.Inc] [name of copyright owner]
#   
    ...
    #    print(result.multi_hand_landmarks)
        ...
        if result.multi_hand_landmarks:
            ...
            for handLms in result.multi_hand_landmarks:
                ...
                ##            click_judge = click_judge + 1
                    ...
                    if i == 8:  # 8 for index finger
                        ...
                        cv2.circle(img, (xPos_8, yPos_8), 10, (0, 0, 180), -1)
                        result8 = corrected_move(
                            xPoslist, yPoslist, xPos_8, yPos_8, fps, crop, result8_l)
                        result8_l = result8
                    if i == 12:
            ...
            #    data.to_excel('sample_data1.xlsx', sheet_name='sheet1', index=False)
                ...
                if dis_8_12 < 0.06:
                    cv2.circle(img, (xPos_12, yPos_12), 10, (0, 0, 180), -1)
