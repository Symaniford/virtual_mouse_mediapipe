build: files produced when being packaged to exe file by pyinstaller.
dist: distributable, folder where exe file is saved.
virtual_mouse.spec: file which explains to pyinstaller how to package the py file
